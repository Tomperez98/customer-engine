...
from backend.core.automatic_responses._cmd import get
from backend.core.automatic_responses.core import (
...
if TYPE_CHECKING:
    ...
    from backend.core.automatic_responses.core import AutomaticResponse
